/*
  You should use the template in the /views directory (index.html) to serve 5 different pages using the same template.
  ...
  You should also use express static functionality to serve style.css from the /assets directory.

  I've provided the javascript objects to pass to mustache for each route below, you just need to create a server
  and pass in the objects to the render() function.
